...
## ⚠️ NOTICE
This extension was previously published at [https://marketplace.visualstudio.com/items?itemName=SridharMocherla.bazel-kotlin-vscode-extension](bazel-kotlin-vscode-extension) on the VSCode marketplace, however it has now been migrated to [https://marketplace.visualstudio.com/items?itemName=Brex.bazel-kotlin](Bazel Kotlin). Please uninstall the old extension and install the new extension to receive updates and new features.
